...
class Scenario(base_scenario.Scenario):
    ...
    def __init__(self):
        self.scenario_description = "Alright agent, our enemy has gotten smarter this time! They've realized we've stolen their password, so they've hidden their new passwords, by putting a '.' in front of the name! Unfortunately, just using ls won't cut it! You'll have to employ advanced tacticts! Use '-a' with 'ls', and that should do the trick!"
        self.hint = "Type 'ls -a' and hit enter. The '-a' is called a flag, and it tells ls to display both the hidden and the non hidden files in this folder. Don't forget to put the dot in front of the name."
